	...
	<div style="padding: 0 0 0 15px;">
		...
		<div id="showtotalDataDIV" style="line-height: 29px;">
			<div id="showTotalData">
				<label style="    margin-left: 30px;" class="col-md-2 col-lg-2 control-label">是否分页显示:</label>
				<div class="col-md-1 col-lg-1">
					<div class="l mr20"> 
						<input type="radio" id="showTotalData" name="showTotalDataKey" value="0">
						<label style="margin: 0;font-weight: normal;" for="showTotalData">是</label>
					</div> 
					<div class="l"> 
						<input type="radio" id="notShowTotalData" name="showTotalDataKey" value="1" checked="checked">
