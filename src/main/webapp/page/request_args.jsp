...
<div  id="request_panel">
	...
	<div  style="padding: 0px 0 0 30px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabl" id="requestTable">
			<thead>
				<tr>
					<th width="50px"><input type="checkbox" /></th>
					<th width="150px">数据库字段&nbsp;&nbsp;&nbsp; <span style="color:red;">*</span></th>
					<th width="100px">查询条件&nbsp;&nbsp;&nbsp; <span style="color:red;">*</span></th>
					<th>参数名称&nbsp;&nbsp;&nbsp; <span style="color:red;">*</span></th>
					<th>中文名称</th>
