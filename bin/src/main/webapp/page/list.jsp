<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="clearfix box inline_any mb20" style="width:100%;">
		...
		<div class="filter_sort clearfix ml20">
			服务所属:
			<select id="service_owner_search" class=" ml5 mr20" onchange="list(1)" style="width:100px;border: 1px solid #d5d5d5;padding: 3px;margin-top: 7px;">				
		...
		<div class="filter_sort clearfix ml20" id="service_type_search">
			服务类型:
			<select id="qry_md_model" class=" ml5 mr20" onchange="list(1)" style="width:100px;border: 1px solid #d5d5d5;padding: 3px;margin-top: 7px;">				
			</select>
		</div>
...
<!-- 		<div>
		...
		<nav>
			<ul class="pager">
			    <li id="countId" >当前页 0/0</li>
				<li id="prePage"   ><a href="##"  >前一页</a></li>
